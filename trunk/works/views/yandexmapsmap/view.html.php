...
class yandexMapsCpViewYandexMapsMap extends JView
{
	...
	function _displayForm($tpl) {
		...
		if ($model->isCheckedOut( $user->get('id') )) {
			$msg = JText::sprintf( 'DESCBEINGEDITTED', JText::_( 'Yandex Maps Maps' ), $item->title );
			$mainframe->redirect( 'index.php?option='. $option, $msg );
		}

		// Set toolbar items for the page
		$text = $isNew ? JText::_( 'New' ) : JText::_( 'Edit' );
		JToolBarHelper::title(   JText::_( 'Yandex Maps Maps' ).': <small><small>[ ' . $text.' ]</small></small>' , 'map');
		JToolBarHelper::save();
		...
		$linkMap = 'index.php?option=com_yandexmaps&amp;view=yandexmapsgmap&amp;tmpl=component&amp;lat='.$latitude.'&amp;lng='.$longitude.'&amp;zoom='.$zoom.'&amp;type=map';
