...
class YandexMapsCpViewYandexMapsMarkers extends JView
{
	function display($tpl = null) {
		...
		JToolBarHelper::title(   JText::_( 'Yandex Maps Markers' ), 'marker' );
		...
		//Filter
		$context			= 'com_yandexmaps.markers.list.';
		$filter_state		= $app->getUserStateFromRequest( $context.'filter_state',	'filter_state',	'',	'word' );
		$filter_catid		= $app->getUserStateFromRequest( $context.'filter_catid',	'filter_catid',	0,	'int' );
