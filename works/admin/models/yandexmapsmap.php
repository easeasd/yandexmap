...
class YandexMapsCpModelYandexMapsMap extends JModel
{
	var $_id			= null;
	var $_data			= null;
	...
	function delete($cid = array()) {
		...
		if (count( $cid )) {
			...
			$query = 'DELETE FROM #__yandexmaps_map'
					. ' WHERE id IN ( '.$cids.' )';
	...
	function _initData() {
		if (empty($this->_data)) {
			...
			$table->doubleclickzoom 	= 0;
			$table->scrollwheelzoom 	= 0;
			$table->zoomcontrol			= 1;
