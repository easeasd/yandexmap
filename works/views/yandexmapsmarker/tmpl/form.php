...
<fieldset class="adminform">
	...
	<table class="admintable">		
		<?php
		$option = array(0 => 'default', 1 => 'gicongrey', 2 => 'giconyellow', 3 => 'giconhome', 4 => 'gicongreen', 5 => 'giconstar');
		echo YandexMapsRender::renderFormInputRadioButton('icon', 'Marker Icon', $this->item->icon, $option, 2);
		?>
	</table>	
</fieldset>
</div>
